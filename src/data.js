      ...
      workout: [
        {
          ...
          description: "Target quads and core with this variation of squats.",
          sets: 4,
          reps: 8,
        },
        {
        ...
        },
        {
          ...
          description: "Target upper chest with this incline press.",
          sets: 4,
          reps: 8,
        },
        {
          exercise: "Weighted Dips",
          description: "Chest and triceps exercise with added resistance.",
          sets: 4,
          reps: 6,
        },
        {
          exercise: "Barbell Shrugs",
          description: "Build traps and upper back strength.",
          sets: 4,
          reps: 8,
        },
        {
          exercise: "T-Bar Rows",
          description: "Focus on mid-back strength.",
          sets: 4,
          reps: 8,
        },
        {
          exercise: "Russian Twists with Weight",
          description: "Core workout with added resistance.",
          sets: 3,
          reps: 20,
        },
        {
          exercise: "Cable Woodchoppers",
          description: "Great for oblique work.",
          sets: 3,
          reps: 15,
        },
      ],
      ...
      workout: [
        {
          ...
          description:
            "Full-body strength workout focusing on posterior chain.",
          sets: 4,
          reps: 8,
        },
        {
          exercise: "Chest-Supported Rows",
          description: "Focus on back thickness and strength.",
          sets: 4,
          reps: 8,
        },
        {
          exercise: "Overhead Dumbbell Press",
          description: "Shoulder strength exercise using dumbbells.",
          sets: 4,
          reps: 8,
        },
        {
          exercise: "Barbell Bicep Curls",
          description: "Focus on biceps with heavy barbell curls.",
          sets: 4,
          reps: 8,
        },
        {
          exercise: "Leg Press",
          description: "Isolation exercise for legs with heavy weights.",
          sets: 4,
          reps: 10,
        },
        {
          ...
          description:
            "Strengthen quads and glutes with this unilateral exercise.",
          sets: 4,
          reps: 8,
        },
        {
          exercise: "Lying Leg Curls",
          description: "Target hamstrings and lower body.",
          sets: 4,
          reps: 12,
        },
        {
          ...
          description:
            "Core exercise focusing on obliques with added resistance.",
          sets: 3,
          reps: 20,
        },
      ],
      ...
      workout: [
        {
          ...
          description: "Heavy compound exercise for legs.",
          sets: 5,
          reps: 5,
        },
        {
          exercise: "Deadlifts",
          description: "Work on hamstrings, glutes, and back.",
          sets: 5,
          reps: 5,
        },
        {
        ...
        {
          exercise: "Pull-Ups with Weights",
          description: "Advanced back training with added resistance.",
          sets: 4,
          reps: 8,
        },
        {
          exercise: "Barbell Rows",
          description: "Strengthen your mid-back.",
          sets: 4,
          reps: 8,
        },
        {
        ...
        },
        {
          ...
          description: "Core workout targeting lower abs.",
          sets: 4,
          reps: 12,
        },
        {
          exercise: "Farmer's Carry",
          description: "Full-body stability and grip strength.",
          sets: 3,
          reps: "20 meters",
        },
      ],
